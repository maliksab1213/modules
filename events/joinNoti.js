...
// ok na yan wag mo i edit itong variable na nasa taas
  ...
  await fs.writeFileSync(pathImg, data);
        ...
        msg = "Hi, {name}. Welcome to {threadName}.\nYou're the {soThanhVien}th member of this group" : msg = threadData.customJoin;
