module.exports.config = {
  name: "womancat",
    ...
    hasPermssion: 0,
    credits: "fk",
    description: "womancat",
    commandCategory: "exit-img",
    cooldowns: 0,
    dependencies: {
        "fs-extra": "",
        "request": ""
...
module.exports.run = async ({ api, event,args }) => {  {
  ...
  const length_2 = parseInt(text2.length)
	 ...
	 return request(encodeURI(`https://api.memegen.link/images/woman-cat/${text1}/${text2}.png`)).pipe(fs.createWriteStream(__dirname+'/cache/poh.png')).on('close',() => callback());     
}}