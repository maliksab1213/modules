...
module.exports.run = async function ({ api, event, args, Users }) {
  if ((this.config.credits) != "fk") { return api.sendMessage(`⚡️Detected credits have been changed`, event.threadID, event.messageID)}
...
if (!res.location || res.location === "Unknown") res.location = "Not Found";
  if (!res.birthday || res.birthday === "Unknown") res.birthday = "Not Found";
if (!res.relationship_status || res.relationship_status === "Unknown") res.relationship_status = "Not Found";
  if (!res.follow || res.follow === "Unknown") res.follow = "Not Found";
