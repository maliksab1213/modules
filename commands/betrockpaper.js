module.exports.config = {
    ...
    hasPermssion: 0,
    credits: `fk`,
    description: `Scissors with a hammer (Science and rock here are the list:scissors, rock, paper)`,
...
module.exports.run = async function({ api, event, args, Users, Currencies }) {
    ...
    if (args[1] < 50 || isNaN(args[1])) return api.sendMessage(`[𝐌𝐎𝐍𝐄𝐘 💸] Your bet level does not match or is below 5000$`, threadID, messageID);
